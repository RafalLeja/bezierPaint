...
def main():
  ...
  argparser.add_argument("-s", "--separator_space", type=int, default=50, help="space between letters")
  argparser.add_argument("-t", "--text", type=str, default="Hello World", help="text to be written")
  argparser.add_argument("-src", "--source", type=str, default="./letters", help="source directory")
  argparser.add_argument("-c", "--color", type=str, default="black", help="Text color")
  argparser.add_argument("-bg", "--background", type=str, default="white", help="Background color")
  argparser.add_argument("-o", "--output", type=str, default="./text.png", help="output file")
  argparser.add_argument("-i", "--italic", type=bool, default=False, help="italic font")
